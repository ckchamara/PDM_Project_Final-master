...
public class sparepart10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart10);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("10").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart10_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("10").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart10_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart10_textview3);
