...
public class sparepart19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart19);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("19").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart19_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("19").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart19_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart19_textview3);
