...
public class sparepart14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart14);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("14").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart14_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("14").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart14_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart14_textview3);
