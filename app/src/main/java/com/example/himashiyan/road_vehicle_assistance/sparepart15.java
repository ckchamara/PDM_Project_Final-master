...
public class sparepart15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart15);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("15").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart15_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("15").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart15_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart15_textview3);
