...
public class sparepart16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart16);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("16").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart16_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("16").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart16_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart16_textview3);
