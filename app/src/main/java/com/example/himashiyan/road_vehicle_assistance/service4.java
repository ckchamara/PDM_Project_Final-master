...
public class service4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("04").child("name");
        nametextview = (TextView) findViewById(R.id.service4_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("04").child("description");
        descriptiontextview = (TextView) findViewById(R.id.service4_textview2);
        ...
        //price text view
        pricedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("04").child("cost");
        pricetextview = (TextView) findViewById(R.id.service4_textview3);
