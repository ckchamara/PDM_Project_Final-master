...
public class sparepart11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart11);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("11").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart11_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("11").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart11_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart11_textview3);
