...
public class service1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("01").child("name");
        nametextview = (TextView) findViewById(R.id.service1_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("01").child("description");
        descriptiontextview = (TextView) findViewById(R.id.service1_textview2);
        ...
        //price text view
        pricedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("01").child("cost");
        pricetextview = (TextView) findViewById(R.id.service1_textview3);
