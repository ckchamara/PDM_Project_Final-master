...
public class service8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("08").child("name");
        nametextview = (TextView) findViewById(R.id.service8_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("08").child("description");
        descriptiontextview = (TextView) findViewById(R.id.service8_textview2);
        ...
        //price text view
        pricedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("08").child("cost");
        pricetextview = (TextView) findViewById(R.id.service8_textview3);
