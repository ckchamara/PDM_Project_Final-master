...
public class sparepart7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart7);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("07").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart7_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("07").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart7_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart7_textview3);
