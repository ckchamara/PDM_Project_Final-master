...
public class sparepart20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart20);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("20").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart20_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("20").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart20_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart20_textview3);
