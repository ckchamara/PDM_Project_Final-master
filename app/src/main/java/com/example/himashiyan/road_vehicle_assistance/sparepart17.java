...
public class sparepart17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart17);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("17").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart17_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("17").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart17_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart17_textview3);
