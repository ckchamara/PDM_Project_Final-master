...
public class sparepart3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart3);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("03").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart3_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("03").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart3_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart3_textview3);
