...
public class service12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("12").child("name");
        nametextview = (TextView) findViewById(R.id.service12_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("12").child("description");
        descriptiontextview = (TextView) findViewById(R.id.service12_textview2);
        ...
        //price text view
        pricedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("12").child("cost");
        pricetextview = (TextView) findViewById(R.id.service12_textview3);
