...
public class sparepart2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart2);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("02").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart2_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("02").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart2_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart2_textview3);
