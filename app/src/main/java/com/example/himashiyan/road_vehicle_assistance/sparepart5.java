...
public class sparepart5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart5);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("05").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart5_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("05").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart5_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart5_textview3);
