...
public class sparepart9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart9);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("09").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart9_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("09").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart9_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart9_textview3);
