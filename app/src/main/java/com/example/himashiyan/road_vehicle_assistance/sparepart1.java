...
public class sparepart1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart1);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("01").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart1_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("01").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart1_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart1_textview3);
