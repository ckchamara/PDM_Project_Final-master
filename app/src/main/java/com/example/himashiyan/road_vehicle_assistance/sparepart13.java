...
public class sparepart13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart13);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("13").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart13_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("13").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart13_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart13_textview3);
