...
public class sparepart6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart6);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("06").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart6_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("06").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart6_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart6_textview3);
