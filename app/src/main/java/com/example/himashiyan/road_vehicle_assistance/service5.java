...
public class service5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("05").child("name");
        nametextview = (TextView) findViewById(R.id.service5_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("05").child("description");
        descriptiontextview = (TextView) findViewById(R.id.service5_textview2);
        ...
        //price text view
        pricedatabase = FirebaseDatabase.getInstance().getReference().child("Services").child("05").child("cost");
        pricetextview = (TextView) findViewById(R.id.service5_textview3);
