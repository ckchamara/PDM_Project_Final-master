...
public class sparepart8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparepart8);

        //name text view
        namedatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("08").child("name");
        nametextview = (TextView) findViewById(R.id.sparepart8_textview1);
        ...
        descriptiondatabase = FirebaseDatabase.getInstance().getReference().child("Parts").child("08").child("description");
        descriptiontextview = (TextView) findViewById(R.id.sparepart8_textview2);
        ...
        pricetextview = (TextView) findViewById(R.id.sparepart8_textview3);
